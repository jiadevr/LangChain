...
## 模型
- 语言模型需要支持工具调用，案例中LangChain部分主要使用qwen-plus，部分使用qwen_max。qwen-plus免费额度足以完成LangChain部分;小米MiMo在实名认证后提供了5元免费调用额度，调用一次约0.01元，数学运算理解能力强于qwen-plus
...
- structed_output.py - 具有结构化输出能力[Structured output](https://docs.langchain.com/oss/python/langchain/structured-output)# 26-4-3发现代码问题，这部分会大量消耗token，待解决
